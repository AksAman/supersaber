...
class SoundDeviceStreamReader(IStreamReader):
    """
    ...
    def __init__(
        ...
        self.device_latency = device_dict[self.device]["default_low_input_latency"]  # type: ignore

        print("\n##################################################################################################")
        print("\nDefaulted to using first working mic, Running on mic %s with properties:" % str(self.device))
        print(device_dict[self.device])  # type: ignore
